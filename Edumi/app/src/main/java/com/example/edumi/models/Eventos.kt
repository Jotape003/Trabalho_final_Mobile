...
val eventos = listOf(
    ...
    Evento(2, "Evento Teste de Notificação", LocalDate.of(2025, 6, 26), LocalTime.now().plusMinutes(2).withSecond(0).withNano(0), LocalTime.now().plusMinutes(65).withSecond(0).withNano(0), "Sala de Teste")
)
